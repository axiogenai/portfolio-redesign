...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "team.axiogen.in",
    "www.axiogen.in",
    "http team axiogen in",
    "https team axiogen in",

    // Common phonetic misspellings & single-letter typos
    "Axigen",
    "Team Axigen",
    "axigen",
    "teamaxigen",
    ...
    // Indic & Regional transliterations (Devanagari, Marathi, Hindi)
    "टीम ॲक्सिओजेन",
    "टीम एक्सिओजेन",
    "अक्सिओजेन",
    "एक्सिओजेन",
    ...
    "टीम अॅक्सिजन",
    "अॅक्सिजन",
    "अॅक्सिओजेन कोल्हापूर",
    "अॅक्सिओजेन सांगली",

    // Brand and entity combinations
    "Axiogen AI",
    "Team Axiogen AI",
    "Axiogen Studio",
    "Team Axiogen Studio",
    "Axiogen Technologies",
    "Team Axiogen Technologies",
    "Axiogen Tech",
    "Team Axiogen Tech",
    "Axiogen Software",
    "Team Axiogen Software",
    "Axiogen Systems",
    "Team Axiogen Systems",
    "Axiogen Labs",
    "Team Axiogen Labs",
    "Axiogen Digital",
    "Team Axiogen Digital",
    "Axiogen India",
    "Team Axiogen India",
    "Axiogen Maharashtra",
    "Team Axiogen Maharashtra",
    "Axiogen Kolhapur",
    "Team Axiogen Kolhapur",
    "Axiogen Sangli",
    "Team Axiogen Sangli",
    ...
    // Proprietary products & internal engines
    "Axiogen ClinicOS",
    "ClinicOS Axiogen",
    "Axiogen Voice Engine",
    "Axiogen Voice Engine v2",
    "Axiogen Vault",
    "Axiogen QR Engine",
    "Axiogen dynamic WAF",
    // Core services
    ...
    "app development Kolhapur",
    "AI company Maharashtra",
